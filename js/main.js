$(document).ready(function() {
    ...
    $('#videofilterOptions li a').click(function() {
        ...
        if (ourClass == 'all') {
            ...
            $('#ourvideoboxes').children(' li:not(.' + ourClass + ')').hide();
            $('#ourvideoboxes').children(' li.' + ourClass).show();
        }
        return false;
    });
    ...
    $('input[name="files"]').fileuploader({
        ...
        upload: {
            ...
            onSuccess: function(result, item) {
                ...
                item.html.find('.column-actions').append('<a class="fileuploader-action fileuploader-action-remove fileuploader-action-success" ><img src="images/close.png"></a>');
                setTimeout(function() {
